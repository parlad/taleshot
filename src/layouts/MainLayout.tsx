          ...
          <div className="flex items-center justify-between">
            ...
            <button onClick={handleLogoClick} className="flex items-center gap-2 hover:scale-105 transition-transform duration-300">
              <div className="relative">
                ...
                <div className="relative p-2 bg-gradient-to-r from-purple-600 to-blue-600 rounded-xl shadow-lg">
        ...
        <div className="max-w-7xl mx-auto px-10 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-base font-semibold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Taleshot</span>
            </div>
