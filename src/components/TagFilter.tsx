  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 hover:border-indigo-200 transition-all duration-300 text-gray-700 text-sm font-medium shadow-sm hover:shadow-md"
      >
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-1 w-44 bg-white/95 backdrop-blur-xl border border-gray-200/50 rounded-lg shadow-xl z-[1000] py-1 overflow-hidden">
          ...
          <div className="py-1">
            <button
              ...
              className={`relative w-full text-left px-3 py-2 text-sm transition-all duration-200 ${
                selectedTag === 'all' 
